...
void BirthdaySha256_99_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BirthdaySha256_99_run(uint ctx_index,Circom_CalcWit* ctx);
...
ctx->componentMemory[coffset].templateName = "BirthdaySha256";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 8;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 256],8);
}
...
BirthdaySha256_99_create(1,0,ctx,"main",0);
BirthdaySha256_99_run(0,ctx);
}
