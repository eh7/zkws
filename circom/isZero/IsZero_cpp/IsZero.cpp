...
// load src
Fr_neg(&expaux[2],&signalValues[mySignalStart + 1]); // line circom 8
Fr_mul(&expaux[1],&expaux[2],&signalValues[mySignalStart + 2]); // line circom 8
Fr_add(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 8
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_mul(&expaux[1],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 0]); // line circom 9
